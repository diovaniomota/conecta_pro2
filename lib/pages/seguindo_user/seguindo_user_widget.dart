...
import 'seguindo_user_model.dart';
export 'seguindo_user_model.dart';

class SeguindoUserWidget extends StatefulWidget {
  const SeguindoUserWidget({
    super.key,
    required this.seguindo,
  });

  final DocumentReference? seguindo;

  @override
  State<SeguindoUserWidget> createState() => _SeguindoUserWidgetState();
}

class _SeguindoUserWidgetState extends State<SeguindoUserWidget> {
  late SeguindoUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SeguindoUserModel());
                      ...
                      child: Column(
                        ...
                        children: [
                          StreamBuilder<UsersRecord>(
                            stream: UsersRecord.getDocument(widget.seguindo!),
                            builder: (context, snapshot) {
                              ...
                              return Builder(
                                builder: (context) {
                                  final seguindo =
                                      listViewUsersRecord.seguindo.toList();
