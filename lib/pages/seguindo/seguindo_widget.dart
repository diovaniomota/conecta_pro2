...
import 'seguindo_model.dart';
export 'seguindo_model.dart';

class SeguindoWidget extends StatefulWidget {
  const SeguindoWidget({
    super.key,
  ...
  @override
  State<SeguindoWidget> createState() => _SeguindoWidgetState();
}

class _SeguindoWidgetState extends State<SeguindoWidget> {
  late SeguindoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SeguindoModel());
