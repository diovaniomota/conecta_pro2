...
class _CriarContaWidgetState extends State<CriarContaWidget> {
  ...
  void initState() {
    ...
    _model.textFieldConfirmaSenhaTextController ??= TextEditingController();
    _model.textFieldConfirmaSenhaFocusNode ??= FocusNode();
                                      ...
                                      children: [
                                        ...
                                        Align(
                                          ...
                                          child: Padding(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  .textFieldConfirmaSenhaTextController,
                                              focusNode: _model
                                                  .textFieldConfirmaSenhaFocusNode,
                                              autofocus: true,
                                              obscureText: !_model
                                                  .textFieldConfirmaSenhaVisibility,
                                              decoration: InputDecoration(
                                                labelStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                                ...
                                                suffixIcon: InkWell(
                                                  ...
                                                  focusNode: FocusNode(
                                                      skipTraversal: true),
                                                  child: Icon(
                                                    _model.textFieldConfirmaSenhaVisibility
                                                        ? Icons
                                                            .visibility_outlined
                                                        : Icons
                                                            .visibility_off_outlined,
                                  ...
                                  onPressed: () async {
                                    ...
                                    await UsersRecord.collection
                                        ...
                                        .update(createUsersRecordData(
                                          ...
                                          isTreinador: widget.isTreinador,
                                        ));

                                    _model.stripeCustomerCreated =
                                        await StripeGroup.criarClienteCall.call(
                                    ...
                                    await currentUserReference!
                                        .update(createUsersRecordData(
                                      stripeCustId: StripeGroup.criarClienteCall
                                          .customerId(
                                        (_model.stripeCustomerCreated
                                                ?.jsonBody ??
                                            ''),
                                          ...
                                          await showDialog(
                                            ...
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                ...
                                                content: const Text(
                                                    'Usuário já cadastrado, clique em entrar!'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
