                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await launchURL(
                                      'https://buy.stripe.com/test_eVa5kJgvOgDndKU000');
                                  ...
                                  if (confirmDialogResponse) {
                                    ...
                                    if (StripeGroup.obterAssinaturaCall
                                      ...
                                      if (StripeGroup.obterStatusAssinaturaCall
                                        ...
                                        context
                                            .pushNamed('TelaDepoisDoPagamento');
                                      } else {
                                        await currentUserReference!
                                            .update(createUsersRecordData(
                                          ativo: false,
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    'por R\$16,90 por mês (16% de desconto)\ncom um pagamento único',
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  _model.semestralResult = await StripeGroup
                                      .checkoutSessionsCall
                                      .call(
                                    customer: valueOrDefault(
                                        currentUserDocument?.stripeCustId, ''),
                                    successUrl:
                                        'https://conectapro2://conectapro2.com/redirect',
                                    cancelUrl:
                                        'https://conectapro2://conectapro2.com/redirect',
                                    price: 'price_1P6Yi02LH1MymCiTN3yfSJHm',
                                  );
                                  await launchURL(getJsonField(
                                    (_model.semestralResult?.jsonBody ?? ''),
                                    r'''$.url''',
                                  ).toString());
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    'por R\$14,90 por mês (27% de desconto)\ncom um pagamento único',
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  _model.anualResult = await StripeGroup
                                      .checkoutSessionsCall
                                      .call(
                                    customer: valueOrDefault(
                                        currentUserDocument?.stripeCustId, ''),
                                    ...
                                    cancelUrl:
                                        'https://conectapro2://conectapro2.com/redirect',
                                    price: 'price_1P6YiS2LH1MymCiTClBNpy5s',
                                  );
                                  await launchURL(getJsonField(
                                    (_model.anualResult?.jsonBody ?? ''),
                                    r'''$.url''',
                                  ).toString());
